<?php
/**
 * WP_Headless_Settings_Disable_Frontend
 *
...
class WP_Headless_Settings_Disable_Frontend extends WP_Headless_Settings {
	...
	private function register_field__post_types() {
		...
		//vars
		$field_slug = self::$plugin_prefix . 'disable-frontend';
